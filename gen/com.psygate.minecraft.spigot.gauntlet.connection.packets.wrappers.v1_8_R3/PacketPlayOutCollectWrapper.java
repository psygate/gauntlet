...
public class PacketPlayOutCollectWrapper implements IPacketPlayOutCollectWrapper {
private final static java.lang.reflect.Field reflect_A;
private final static java.lang.reflect.Field reflect_B;
static {
try {
reflect_A = net.minecraft.server.v1_8_R3.PacketPlayOutCollect.class.getDeclaredField("a");
reflect_A.setAccessible(true);reflect_B = net.minecraft.server.v1_8_R3.PacketPlayOutCollect.class.getDeclaredField("b");
reflect_B.setAccessible(true);} catch(Exception e) {throw new RuntimeException(e);}
}
private net.minecraft.server.v1_8_R3.PacketPlayOutCollect packet;

public PacketPlayOutCollectWrapper(net.minecraft.server.v1_8_R3.PacketPlayOutCollect packet) {
this.packet = Objects.requireNonNull(packet, () -> "Provided packet for wrapper cannot be null.");
}

public net.minecraft.server.v1_8_R3.PacketPlayOutCollect unwrap() {return packet;}
public int getA() {
try {
...
throw new RuntimeException(e);
    ...
    public String toString() {
        return "PacketPlayOutCollect[" + getA()+", "+getB() + "]";
    }
