...
public class PacketPlayOutAttachEntityWrapper implements IPacketPlayOutAttachEntityWrapper {
...
static {
try {
reflect_A = net.minecraft.server.v1_8_R3.PacketPlayOutAttachEntity.class.getDeclaredField("a");
reflect_A.setAccessible(true);reflect_B = net.minecraft.server.v1_8_R3.PacketPlayOutAttachEntity.class.getDeclaredField("b");
reflect_B.setAccessible(true);reflect_C = net.minecraft.server.v1_8_R3.PacketPlayOutAttachEntity.class.getDeclaredField("c");
reflect_C.setAccessible(true);} catch(Exception e) {throw new RuntimeException(e);}
}
private net.minecraft.server.v1_8_R3.PacketPlayOutAttachEntity packet;

public PacketPlayOutAttachEntityWrapper(net.minecraft.server.v1_8_R3.PacketPlayOutAttachEntity packet) {
this.packet = Objects.requireNonNull(packet, () -> "Provided packet for wrapper cannot be null.");
}

public net.minecraft.server.v1_8_R3.PacketPlayOutAttachEntity unwrap() {return packet;}
public int getA() {
try {
...
throw new RuntimeException(e);
    ...
    public String toString() {
        return "PacketPlayOutAttachEntity[" + getA()+", "+getB()+", "+getC() + "]";
    }
