...
public class PacketPlayOutKeepAliveWrapper implements IPacketPlayOutKeepAliveWrapper {
private final static java.lang.reflect.Field reflect_A;
static {
try {
reflect_A = net.minecraft.server.v1_8_R3.PacketPlayOutKeepAlive.class.getDeclaredField("a");
reflect_A.setAccessible(true);} catch(Exception e) {throw new RuntimeException(e);}
}
private net.minecraft.server.v1_8_R3.PacketPlayOutKeepAlive packet;

public PacketPlayOutKeepAliveWrapper(net.minecraft.server.v1_8_R3.PacketPlayOutKeepAlive packet) {
this.packet = Objects.requireNonNull(packet, () -> "Provided packet for wrapper cannot be null.");
}

public net.minecraft.server.v1_8_R3.PacketPlayOutKeepAlive unwrap() {return packet;}
public int getA() {
try {
...
throw new RuntimeException(e);
    ...
    public String toString() {
        return "PacketPlayOutKeepAlive[" + getA() + "]";
    }
