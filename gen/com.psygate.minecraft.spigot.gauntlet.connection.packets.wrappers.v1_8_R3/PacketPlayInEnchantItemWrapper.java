...
public class PacketPlayInEnchantItemWrapper implements IPacketPlayInEnchantItemWrapper {
private final static java.lang.reflect.Field reflect_A;
private final static java.lang.reflect.Field reflect_B;
static {
try {
reflect_A = net.minecraft.server.v1_8_R3.PacketPlayInEnchantItem.class.getDeclaredField("a");
reflect_A.setAccessible(true);reflect_B = net.minecraft.server.v1_8_R3.PacketPlayInEnchantItem.class.getDeclaredField("b");
reflect_B.setAccessible(true);} catch(Exception e) {throw new RuntimeException(e);}
}
private net.minecraft.server.v1_8_R3.PacketPlayInEnchantItem packet;

public PacketPlayInEnchantItemWrapper(net.minecraft.server.v1_8_R3.PacketPlayInEnchantItem packet) {
this.packet = Objects.requireNonNull(packet, () -> "Provided packet for wrapper cannot be null.");
}

public net.minecraft.server.v1_8_R3.PacketPlayInEnchantItem unwrap() {return packet;}
public int getA() {
try {
...
throw new RuntimeException(e);
    ...
    public String toString() {
        return "PacketPlayInEnchantItem[" + getA()+", "+getB() + "]";
    }
