...
public class PacketPlayOutEntityVelocityWrapper implements IPacketPlayOutEntityVelocityWrapper {
...
static {
try {
reflect_A = net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity.class.getDeclaredField("a");
reflect_A.setAccessible(true);reflect_B = net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity.class.getDeclaredField("b");
reflect_B.setAccessible(true);reflect_C = net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity.class.getDeclaredField("c");
reflect_C.setAccessible(true);reflect_D = net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity.class.getDeclaredField("d");
reflect_D.setAccessible(true);} catch(Exception e) {throw new RuntimeException(e);}
}
private net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity packet;

public PacketPlayOutEntityVelocityWrapper(net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity packet) {
this.packet = Objects.requireNonNull(packet, () -> "Provided packet for wrapper cannot be null.");
}

public net.minecraft.server.v1_8_R3.PacketPlayOutEntityVelocity unwrap() {return packet;}
public int getA() {
try {
...
throw new RuntimeException(e);
    ...
    public String toString() {
        return "PacketPlayOutEntityVelocity[" + getA()+", "+getB()+", "+getC()+", "+getD() + "]";
    }
